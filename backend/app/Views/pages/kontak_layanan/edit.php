                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="tipe" name="tipe" required>
                            <option value="download" <?= old('tipe', $kontak['tipe']) == 'download' ? 'selected' : '' ?>>Download</option>
                            <option value="whatsapp" <?= old('tipe', $kontak['tipe']) == 'whatsapp' ? 'selected' : '' ?>>WhatsApp</option>
                            <option value="layanan" <?= old('tipe', $kontak['tipe']) == 'layanan' ? 'selected' : '' ?>>Layanan Link</option>
                            <option value="sp4n" <?= old('tipe', $kontak['tipe']) == 'sp4n' ? 'selected' : '' ?>>SP4N Lapor</option>
                            <option value="darurat" <?= old('tipe', $kontak['tipe']) == 'darurat' ? 'selected' : '' ?>>Darurat</option>
                        </select>
                    </div>
                    <div class="col-md-4">
