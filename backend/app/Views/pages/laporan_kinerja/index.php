...
<div class="container-fluid px-4 pb-5">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between my-4 py-2">
        <div class="mb-3 mb-md-0">
            <h1 class="h3 fw-bolder mb-1 text-gradient">Laporan Kinerja</h1>
            <p class="text-muted small mb-0">
                <i class="fas fa-chart-line me-1 text-primary"></i> 
                Kelola laporan kinerja seperti LAKIP, RENJA, dan Evaluasi Kinerja.
            </p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white px-3 py-2 rounded-pill shadow-sm mb-0 border">
                ...
                <li class="breadcrumb-item active small" aria-current="page">Laporan Kinerja</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card card-modern">
        <div class="card-header bg-white py-4 border-0 d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold text-dark mb-0">Daftar Laporan Kinerja</h5>
                <span class="text-muted small">Laporan evaluasi dan capaian kinerja</span>
            </div>
            
            <?php if ($can_create): ?>
                <a href="<?= base_url('laporan_kinerja/new') ?>" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold mt-3 mt-md-0 hover-scale">
                ...
                <div class="text-center py-5">
                    <div class="py-4">
                        <div class="mb-3 opacity-25">
                            <i class="fas fa-chart-pie fa-4x text-secondary"></i>
                        </div>
                        <h6 class="fw-bold text-secondary">Belum ada data laporan</h6>
                        <p class="small text-muted mb-0">Silakan tambahkan laporan kinerja baru.</p>
                        <?php if ($can_create): ?>
                            <a href="<?= base_url('laporan_kinerja/new') ?>" class="btn btn-primary rounded-pill px-4 mt-3 shadow-sm hover-scale">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <?php if ($can_update): ?>
                                                <a href="<?= base_url('laporan_kinerja/' . $item['id_laporan_kinerja'] . '/edit') ?>" 
                                            ...
                                            <?php if ($can_delete): ?>
                                                <form action="<?= base_url('laporan_kinerja/' . $item['id_laporan_kinerja']) ?>" 
                                                      method="POST" 
        ...
        <div class="card-footer bg-white border-top-0 py-3">
            <div class="d-flex align-items-center text-muted small">
                ...
                <span>Laporan kinerja meliputi LAKIP (Laporan Akuntabilitas Kinerja Instansi Pemerintah), RENJA, dan evaluasi triwulan.</span>
            </div>
        </div>
    </div>
</div>
