...
<div class="container-fluid px-4">
    <h1 class="mt-4">Edit Laporan Kinerja</h1>
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('laporan_kinerja/' . $doc['id_laporan_kinerja']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="kategori" class="form-control" value="<?= old('kategori', $doc['kategori']) ?>" required>
                    </div>
