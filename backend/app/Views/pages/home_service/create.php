...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 shadow-sm border-0">
        <div class="card-header bg-white py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-plus-circle me-1"></i> Form Tambah Layanan</h6>
        </div>
        <div class="card-body">
            <form action="/home_service" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Contoh: Layanan Pengaduan" value="<?= old('title') ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" class="form-control" name="link" placeholder="https://..." value="<?= old('link') ?>">
                            </div>
                        ...
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                ...
                                <div class="mb-3 position-relative" style="width: 150px; height: 150px; border: 2px dashed #ccc; border-radius: 10px; display: flex; align-items: center; justify-content: center; background: #fff; overflow: hidden;">
                                    ...
                                    <span id="icon-placeholder" class="text-muted small">Preview</span>
                                </div>
