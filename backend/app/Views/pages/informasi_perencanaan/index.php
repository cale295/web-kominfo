...
<div class="container-fluid px-4 pb-5">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between my-4 py-2">
        <div class="mb-3 mb-md-0">
            <h1 class="h3 fw-bolder mb-1 text-gradient">Informasi Perencanaan</h1>
            <p class="text-muted small mb-0">
                <i class="fas fa-file-contract me-1 text-primary"></i> 
                Kelola dokumen perencanaan seperti RENSTRA, RENJA, dan RKPD.
            </p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white px-3 py-2 rounded-pill shadow-sm mb-0 border">
                ...
                <li class="breadcrumb-item active small" aria-current="page">Dokumen Perencanaan</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card card-modern">
        <div class="card-header bg-white py-4 border-0 d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold text-dark mb-0">Daftar Dokumen</h5>
                <span class="text-muted small">Dokumen perencanaan strategis dan teknis</span>
            </div>
            
            <?php if ($can_create): ?>
                <a href="<?= base_url('informasi_perencanaan/new') ?>" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold mt-3 mt-md-0 hover-scale">
            ...
            <?php if (empty($documents)): ?>
                <div class="text-center py-5">
                    <div class="py-4">
                        ...
                        <p class="small text-muted mb-0">Silakan tambahkan dokumen perencanaan baru.</p>
                        <?php if ($can_create): ?>
                            <a href="<?= base_url('informasi_perencanaan/new') ?>" class="btn btn-primary rounded-pill px-4 mt-3 shadow-sm hover-scale">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <?php if ($can_update): ?>
                                                <a href="<?= base_url('informasi_perencanaan/' . $item['id_perencanaan'] . '/edit') ?>" 
                                            ...
                                            <?php if ($can_delete): ?>
                                                <form action="<?= base_url('informasi_perencanaan/' . $item['id_perencanaan']) ?>" 
                                                      method="POST" 
        ...
        <div class="card-footer bg-white border-top-0 py-3">
            <div class="d-flex align-items-center text-muted small">
                ...
                <span>Dokumen perencanaan meliputi RENSTRA, RENJA, RKPD, dan dokumen strategis lainnya.</span>
            </div>
        </div>
    </div>
</div>
