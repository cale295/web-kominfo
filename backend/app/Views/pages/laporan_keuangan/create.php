...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('laporan_keuangan') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_dokumen" class="form-control" value="<?= old('judul_dokumen') ?>" placeholder="Contoh: Laporan Keuangan Tahun 2024" required>
                </div>
