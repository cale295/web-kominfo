...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('permohonan_informasi/' . $doc['id_permohonan']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="tahun" class="form-control" value="<?= old('tahun', $doc['tahun']) ?>">
                </div>
