...
<div class="form-card">
    ...
    <div class="info-box">
        ...
        <div class="info-box-text">
            ...
            Buat kategori baru untuk mengelompokkan dokumen berdasarkan jenis atau tujuannya. Berikan nama yang jelas dan deskriptif.
        </div>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="mb-3">
                ...
                <textarea 
                    ...
                    class="form-control" 
                    rows="4"
                    placeholder="Jelaskan detail tentang kategori ini..."><?= old('category_description') ?></textarea>
                <small class="form-text">
                    <i class="bi bi-info-circle"></i>
