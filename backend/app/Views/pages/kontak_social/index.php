    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCreateLabel"><i class="fas fa-plus me-1"></i> Tambah Kontak Social</h5>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditLabel"><i class="fas fa-edit me-2"></i> Edit Kontak Social</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formEdit" action="" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="edit_platform" class="form-label fw-bold text-secondary small text-uppercase">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="edit_icon_class" class="form-label fw-bold text-secondary small text-uppercase">
                                Pilih Icon <span class="text-danger">*</span>
                            </label>
                            <div class="input-group">
                                <div class="input-group-text bg-light border-end-0">
                                    <div class="d-flex justify-content-center align-items-center bg-primary text-white rounded-circle shadow-sm" style="width: 24px; height: 24px;">
                                        <i id="edit-icon-preview" class="fas fa-icons" style="font-size: 0.8rem;"></i>
                                    </div>
                                </div>
                                <select class="form-select border-start-0 ps-0 bg-light" id="edit_icon_class" name="icon_class" required onchange="updateIconPreview(this, 'edit-icon-preview')">
                                    <option value="">-- Pilih Icon --</option>
                                    <?php foreach ($socialIcons as $class => $label): ?>
                                        <option value="<?= $class ?>">
                                            <?= $label ?> (<?= $class ?>)
                    ...
                    <div class="mb-3">
                        <label for="edit_link_url" class="form-label fw-bold text-secondary small text-uppercase">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="edit_urutan" class="form-label fw-bold text-secondary small text-uppercase">Urutan</label>
