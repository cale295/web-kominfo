...
<div class="container-fluid px-4 pb-5">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between my-4 py-2">
        <div class="mb-3 mb-md-0">
            <h1 class="h3 fw-bolder mb-1 text-gradient">IP Kerjasama Daerah</h1>
            <p class="text-muted small mb-0">
                <i class="fas fa-handshake me-1 text-primary"></i> 
                Informasi Publik terkait Kerjasama Daerah dan MoU.
            </p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white px-3 py-2 rounded-pill shadow-sm mb-0 border">
                ...
                <li class="breadcrumb-item active small" aria-current="page">Kerjasama Daerah</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card card-modern">
        <div class="card-header bg-white py-4 border-0 d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold text-dark mb-0">Daftar Kerjasama</h5>
                <span class="text-muted small">Dokumen MoU dan perjanjian kerjasama daerah</span>
            </div>
            
            <?php if ($can_create): ?>
                <a href="/ip_kerjasama_daerah/new" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold mt-3 mt-md-0 hover-scale">
            ...
            <?php if (empty($kerjasama)) : ?>
                <div class="text-center py-5">
                    <div class="py-4">
                        ...
                        <?php if ($can_create): ?>
                            <a href="/ip_kerjasama_daerah/new" class="btn btn-primary rounded-pill px-4 mt-3 shadow-sm hover-scale">
                        ...
                        <tbody>
                            <?php foreach ($kerjasama as $index => $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge-nomor"><?= esc($item['nomor']) ?></span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <?php if ($can_update): ?>
                                                <a href="/ip_kerjasama_daerah/<?= $item['id'] ?>/edit" 
                                            ...
                                            <?php if ($can_delete): ?>
                                                <form action="/ip_kerjasama_daerah/<?= $item['id'] ?>" 
                                                      method="post" 
        ...
        <div class="card-footer bg-white border-top-0 py-3">
            <div class="d-flex align-items-center text-muted small">
                ...
                <span>Dokumen MoU (Memorandum of Understanding) dan perjanjian kerjasama antar daerah.</span>
            </div>
        </div>
    </div>
</div>
