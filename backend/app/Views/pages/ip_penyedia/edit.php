...
<div class="container-fluid px-4">
    <h1 class="mt-4">Edit IP Penyedia</h1>
    ...
    <div class="card mb-4 shadow-sm border-0">
        ...
        <div class="card-body">
            <form action="/ip_penyedia/<?= $item['id'] ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="jenis_pengadaan" value="<?= old('jenis_pengadaan', $item['jenis_pengadaan']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Metode Pengadaan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="metode_pengadaan" value="<?= old('metode_pengadaan', $item['metode_pengadaan']) ?>" required>
                    </div>
                </div>
