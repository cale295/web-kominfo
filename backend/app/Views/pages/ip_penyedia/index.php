...
<div class="container-fluid px-4 pb-5">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between my-4 py-2">
        <div class="mb-3 mb-md-0">
            <h1 class="h3 fw-bolder mb-1 text-gradient">IP Penyedia</h1>
            <p class="text-muted small mb-0">
                <i class="fas fa-boxes me-1 text-primary"></i> 
                Informasi Pengadaan Penyedia Barang/Jasa berdasarkan RUP.
            </p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white px-3 py-2 rounded-pill shadow-sm mb-0 border">
                ...
                <li class="breadcrumb-item active small" aria-current="page">IP Penyedia</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card card-modern">
        <div class="card-header bg-white py-4 border-0 d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold text-dark mb-0">Daftar Paket</h5>
                <span class="text-muted small">Paket pengadaan barang/jasa berdasarkan RUP</span>
            </div>
            
            <?php if ($can_create): ?>
                <a href="/ip_penyedia/new" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold mt-3 mt-md-0 hover-scale">
            ...
            <?php if (empty($ip_penyedia)) : ?>
                <div class="text-center py-5">
                    <div class="py-4">
                        ...
                        <?php if ($can_create): ?>
                            <a href="/ip_penyedia/new" class="btn btn-primary rounded-pill px-4 mt-3 shadow-sm hover-scale">
                    ...
                    <table class="table table-hover align-middle mb-0" id="dataTable">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="py-3" width="10%">ID RUP</th>
                                <th class="py-3" width="30%">Nama Paket</th>
                                <th class="py-3" width="15%">Jenis</th>
                                <th class="py-3" width="15%">Metode</th>
                                <th class="text-end py-3" width="15%">Pagu Anggaran</th>
                                <th class="text-center py-3" width="10%">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($ip_penyedia as $index => $item) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <?php if ($can_update): ?>
                                                <a href="/ip_penyedia/<?= $item['id'] ?>/edit" 
                                            ...
                                            <?php if ($can_delete): ?>
                                                <form action="/ip_penyedia/<?= $item['id'] ?>" 
                                                      method="post" 
        ...
        <div class="card-footer bg-white border-top-0 py-3">
            <div class="d-flex align-items-center text-muted small">
                ...
                <span>RUP (Rencana Umum Pengadaan) berdasarkan Perpres No. 16 Tahun 2018 tentang Pengadaan Barang/Jasa Pemerintah.</span>
            </div>
        </div>
    </div>
</div>
