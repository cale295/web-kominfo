...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .brand-icon { color: var(--primary); margin-right: 10px; font-size: 1.4rem; }
    ...
    .user-avatar { width: 42px; height: 42px; border-radius: 10px; border: 1px solid var(--border); object-fit: cover; }
    .user-details { overflow: hidden; flex: 1; }
    .user-name { font-weight: 700; color: #334155; font-size: 0.9rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .user-role { font-size: 0.7rem; color: var(--primary); text-transform: uppercase; font-weight: 700; letter-spacing: 0.5px; }

    .sidebar-menu-wrapper { flex: 1; overflow-y: auto; padding: 0 0 2rem 0; }
    ...
    .menu-header {
        ...
        text-transform: uppercase; margin: 1.5rem 0 0.5rem 1.5rem; letter-spacing: 0.5px;
    }
    ...
    .submenu-item-level-3 {
        ...
        margin: 0 0.75rem 0.15rem 0.75rem; border-radius: 8px;
    }
