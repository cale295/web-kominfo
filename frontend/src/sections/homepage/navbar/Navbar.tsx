          ...
          {isMobile ? (
            ...
            <>
              ...
              >
                {menu.menu_name}
                {hasChildren && depth === 0 && (
                  <ChevronDown size={12} className="ms-1 inline" />
                )}
              </a>
  ...
  return (
    <nav className="bg-gradient-to-r-blue-800-950 text-white rounded-top-6 rounded-top-sm-4 rounded-top-md-4 rounded-top-lg-4 rounded-top-xl-4 rounded-top-xxl-4 shadow-md">
      <div className="d-flex align-items-center position-relative px-4 px-md-5 px-lg-6 px-xl-6 px-xxl-6 py-6 h-20 flex-wrap">
        ...
        {/* Logo & Judul */}
        <div className="flex-grow-1 d-flex flex-md-column align-items-center justify-content-center text-center mt-5">
          <img
            src="/assets/logo.png"
            alt="Logo Kominfo"
          ...
          <button
            ...
            onClick={() => {
              ...
              setOpenSubmenu(null); // Reset submenu saat tutup
            }}
      ...
      <div className="w-100 navbar-wrapper d-none d-md-block">
        <div className="d-flex justify-content-center min-width-max px-3 px-md-5 py-3 font-semibold text-md">
