...
const MainBerita: React.FC = () => {
  ...
  // Props untuk komponen RightSide
  ...
  return (
    <div className="container-fluid my-5 berita-container">
      ...
      <div className="row g-4">
        ...
        {!isFilterMode && (
          <>
            {/* Left Side - Berita Utama & Berita Terkini */}
            <LeftSide {...leftSideProps} />
            
            {/* Right Side - Berita Populer & Tag Populer */}
